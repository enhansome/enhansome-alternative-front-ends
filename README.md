...
* Just create an [issue](https://github.com/mendel5/alternative-front-ends/issues) ⭐ 9,177 | 🐛 112 | 📅 2024-08-18 and let me know. I'm always looking for new free/open-source projects to add.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,951 | 🐛 2,665 | 🌐 Python | 📅 2026-09-16: A youtube-dl fork with additional features and fixes

* [Youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,322 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19: Command-line program to download videos from YouTube.com and other video sites

* [NewPipe](https://github.com/TeamNewPipe/NewPipe) ⭐ 39,753 | 🐛 1,472 | 🌐 Java | 📅 2026-09-21: A libre lightweight streaming front-end for Android

* [SmartTubeNext](https://github.com/yuliskov/SmartTubeNext) ⭐ 34,019 | 🐛 728 | 🌐 Java | 📅 2026-09-22: SmartTubeNext is an advanced YouTube app for Android TVs and TV boxes, free and open source. It is not a live TV client and does not support "YouTube TV"

* [Invidious](https://github.com/iv-org/invidious) ⭐ 24,732 | 🐛 492 | 🌐 Crystal | 📅 2026-09-18: Invidious is an alternative front-end to YouTube - Lightweight, no ads, no tracking, no JavaScript required
...
* [FreeTube](https://github.com/FreeTubeApp/FreeTube) ⭐ 21,967 | 🐛 305 | 🌐 Vue | 📅 2026-09-21: Open source YouTube desktop player for privacy on Windows, Mac and Linux
  * Official Instance: <https://freetubeapp.io/>

* [LibreTube](https://github.com/libre-tube/LibreTube) ⭐ 12,717 | 🐛 162 | 🌐 Kotlin | 📅 2026-09-22: Android frontend for YouTube, based on Piped
...
* [OpenVideoDownloader aka jely2002/youtube-dl-gui](https://github.com/jely2002/youtube-dl-gui) ⭐ 9,268 | 🐛 78 | 🌐 Rust | 📅 2026-09-13: A cross-platform GUI for youtube-dl made in Electron and node.js
...
* [TubeArchivist](https://github.com/tubearchivist/tubearchivist) ⭐ 8,463 | 🐛 24 | 🌐 Python | 📅 2026-08-28: A self hosted YouTube media server
...
* [YouTube.js](https://github.com/LuanRT/YouTube.js) ⭐ 5,334 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-22: Full-featured wrapper around the Innertube API, which is what YouTube itself uses
...
* [yattee](https://github.com/yattee/yattee) ⭐ 3,699 | 🐛 226 | 🌐 Swift | 📅 2026-08-23: Alternative YouTube frontend for iOS, tvOS and macOS built with Invidious and Piped, supports sponsorblock
...
* [TubeSync](https://github.com/meeb/tubesync) ⭐ 2,796 | 🐛 58 | 🌐 Python | 📅 2026-09-22: TubeSync is a PVR (personal video recorder) for YouTube. It syncs YouTube channels and playlists to a locally hosted media server
...
* [ViewTube](https://github.com/ViewTube/viewtube-vue) ⭐ 1,476 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-19: An alternative front-end for YouTube, written in Vue.js, uses Plyr video player; supports SponsorBlock, multiple Invidious instances support, chapters
...
* [th-ch/youtube-music](https://github.com/th-ch/youtube-music) ⭐ 33,556 | 🐛 690 | 🌐 TypeScript | 📅 2026-09-22: YouTube Music desktop app based on Electron bundled with custom plugins (including built-in ad blocker and downloader)

* [ytmdesktop](https://github.com/ytmdesktop/ytmdesktop) ⭐ 6,528 | 🐛 356 | 🌐 TypeScript | 📅 2026-09-13: Cross-platform (Windows, Mac, and Linux) desktop app for YouTube Music. Has a (proprietary?) remote control app for Android
...
* [Infinity](https://github.com/Docile-Alligator/Infinity-For-Reddit) ⭐ 5,514 | 🐛 164 | 🌐 Java | 📅 2026-09-22: Reddit client for Android
...
* [Top of Reddit](https://github.com/mgerb/top-of-reddit) ⭐ 43 | 🐛 0 | 🌐 Go | 📅 2026-09-22: Top Reddit posts every day
...
* [spotube](https://github.com/KRTirtho/spotube) ⭐ 49,352 | 🐛 866 | 🌐 Dart | 📅 2026-09-12: A lightweight and free Spotify crossplatform-client which handles playback manually, streams music using Youtube & no Spotify premium account is needed

* [SpotX](https://github.com/amd64fox/SpotX) ⭐ 22,434 | 🐛 2 | 🌐 PowerShell | 📅 2026-09-22: Modified Spotify Client for Windows (Windows Only) - Blocking ads and updates for the desktop version of Spotify, disabling podcasts and more

* [spotifyd](https://github.com/Spotifyd/spotifyd) ⭐ 10,780 | 🐛 76 | 🌐 Rust | 📅 2026-05-28: unix daemon, using librespot.

* [psst](https://github.com/jpochyla/psst) ⭐ 9,482 | 🐛 153 | 🌐 Rust | 📅 2026-08-18: Fast and multi-platform Spotify client with native GUI

* [librespot](https://github.com/librespot-org/librespot) ⭐ 7,167 | 🐛 140 | 🌐 Rust | 📅 2026-09-11: Requires Spotify Premium Account - librespot is an open source client library for Spotify. It enables applications to use Spotify's service to control and play music via various backends, and to act as a Spotify Connect receiver. It is an alternative to the official and now deprecated closed-source libspotify. Additionally, it will provide extra features which are not available in the official library
...
* [Xtra](https://github.com/crackededed/Xtra) ⭐ 2,272 | 🐛 189 | 🌐 Kotlin | 📅 2026-09-22: Twitch player and browser for Android
...
* [SearXNG](https://github.com/searxng/searxng) ⭐ 37,509 | 🐛 209 | 🌐 Python | 📅 2026-09-22: SearXNG is a free internet metasearch engine which aggregates results from various search services and databases. Users are neither tracked nor profiled (SearXNG is a fork of searx)
...
* [SlimSocial](https://github.com/rignaneseleo/SlimSocial-for-Facebook) ⭐ 542 | 🐛 13 | 🌐 Dart | 📅 2026-09-19: Android, alternative front-end for Facebook, built with Java

### Facebook Messenger

* [Caprine](https://github.com/sindresorhus/caprine) ⭐ 7,394 | 🐛 294 | 🌐 TypeScript | 📅 2026-01-02: Unofficial and privacy-focused Facebook Messenger app with many useful features
...
* [vaultwarden](https://github.com/dani-garcia/vaultwarden) ⭐ 68,026 | 🐛 82 | 🌐 Rust | 📅 2026-09-18: Password manager. Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden\_rs

* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,115 | 🐛 2,473 | 🌐 Go | 📅 2026-09-22: Lightweight git server. Git with a cup of tea, painless self-hosted git service

* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,575 | 🐛 160 | 🌐 Python | 📅 2026-09-22: Open source self-hosted web archiving. Takes URLs/browser history/bookmarks/Pocket/Pinboard/etc., saves HTML, JS, PDFs, media, and more

* [etherpad-lite](https://github.com/ether/etherpad-lite) ⭐ 18,554 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22: Collaborative rich text editor. A modern really-real-time collaborative document editor

* [PrivateBin](https://github.com/PrivateBin/PrivateBin) ⭐ 8,608 | 🐛 214 | 🌐 PHP | 📅 2026-09-21: Zero knowledge encrypted paste-bin. A minimalist, open source online pastebin where the server has zero knowledge of pasted data. Data is encrypted/decrypted in the browser using 256 bits AES

* [hedgedoc](https://github.com/hedgedoc/hedgedoc) ⭐ 7,441 | 🐛 298 | 🌐 TypeScript | 📅 2026-09-22: Collaborative markdown editor. A platform to write and share markdown
...
* [snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 28 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15: Similar to Apple's Airdrop but in your browser. A Progressive Web App for local file sharing
...
* [libredirect](https://github.com/libredirect/libredirect) ⭐ 4,059 | 🐛 51 | 🌐 JavaScript | 📅 2026-08-12: A web extension that redirects popular sites to alternative privacy-friendly frontends and backends. Actively maintained fork of Privacy Redirect that supports Youtube, Youtube Music, Twitter, TikTok, Imgur, Reddit, Searx, Google Translate, Google Maps, Wikipedia, and Medium
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 68,050 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-22: An efficient blocker for Chromium and Firefox. Fast and lean
...
* [Pluja's Awesome Privacy](https://github.com/pluja/awesome-privacy) ⭐ 19,827 | 🐛 603 | 🌐 Python | 📅 2026-07-15: A curated list of services and alternatives that respect your privacy because privacy matters.
...
* [StreetComplete](https://github.com/streetcomplete/StreetComplete) ⭐ 4,802 | 🐛 149 | 🌐 Kotlin | 📅 2026-09-22: Easy to use OpenStreetMap editor for Android
