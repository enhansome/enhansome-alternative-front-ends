...
* Just create an [issue](https://github.com/mendel5/alternative-front-ends/issues) ⭐ 9,179 | 🐛 112 | 📅 2024-08-18 and let me know. I'm always looking for new free/open-source projects to add.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,593 | 🐛 2,682 | 🌐 Python | 📅 2026-09-16: A youtube-dl fork with additional features and fixes

* [Youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,367 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19: Command-line program to download videos from YouTube.com and other video sites

* [NewPipe](https://github.com/TeamNewPipe/NewPipe) ⭐ 39,777 | 🐛 1,470 | 🌐 Java | 📅 2026-09-25: A libre lightweight streaming front-end for Android

* [SmartTubeNext](https://github.com/yuliskov/SmartTubeNext) ⭐ 34,136 | 🐛 741 | 🌐 Java | 📅 2026-09-23: SmartTubeNext is an advanced YouTube app for Android TVs and TV boxes, free and open source. It is not a live TV client and does not support "YouTube TV"

* [Invidious](https://github.com/iv-org/invidious) ⭐ 24,782 | 🐛 493 | 🌐 Crystal | 📅 2026-09-25: Invidious is an alternative front-end to YouTube - Lightweight, no ads, no tracking, no JavaScript required
...
* [FreeTube](https://github.com/FreeTubeApp/FreeTube) ⭐ 21,986 | 🐛 302 | 🌐 Vue | 📅 2026-09-25: Open source YouTube desktop player for privacy on Windows, Mac and Linux
  * Official Instance: <https://freetubeapp.io/>

* [LibreTube](https://github.com/libre-tube/LibreTube) ⭐ 12,728 | 🐛 172 | 🌐 Kotlin | 📅 2026-09-25: Android frontend for YouTube, based on Piped

* [Piped](https://github.com/TeamPiped/Piped) ⭐ 10,260 | 🐛 319 | 🌐 Vue | 📅 2026-09-25: An alternative privacy-friendly YouTube frontend which is efficient by design - Lightweight, no ads, no tracking
  * Public instances: <https://github.com/TeamPiped/Piped/wiki/Instances> ⭐ 10,260 | 🐛 319 | 🌐 Vue | 📅 2026-09-25
...
* [OpenVideoDownloader aka jely2002/youtube-dl-gui](https://github.com/jely2002/youtube-dl-gui) ⭐ 9,288 | 🐛 83 | 🌐 Rust | 📅 2026-09-13: A cross-platform GUI for youtube-dl made in Electron and node.js
...
* [TubeArchivist](https://github.com/tubearchivist/tubearchivist) ⭐ 8,472 | 🐛 24 | 🌐 Python | 📅 2026-08-28: A self hosted YouTube media server
...
* [YouTube.js](https://github.com/LuanRT/YouTube.js) ⭐ 5,336 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-24: Full-featured wrapper around the Innertube API, which is what YouTube itself uses
...
* [ytmdl](https://github.com/deepjyoti30/ytmdl) ⭐ 3,538 | 🐛 17 | 🌐 Python | 📅 2024-08-15: A simple app to get songs from YouTube in mp3 format with artist name, album name etc from sources like iTunes, LastFM, Deezer, Gaana etc.

* [Tartube](https://github.com/axcore/tartube) ⭐ 3,143 | 🐛 23 | 🌐 Python | 📅 2026-09-21: A GUI front-end for youtube-dl, partly based on youtube-dl-gui and written in Python 3 / Gtk 3

* [Alltube](https://github.com/Rudloff/alltube) ⚠️ Archived: Web GUI for youtube-dl

* [TubeSync](https://github.com/meeb/tubesync) ⭐ 2,798 | 🐛 57 | 🌐 Python | 📅 2026-09-25: TubeSync is a PVR (personal video recorder) for YouTube. It syncs YouTube channels and playlists to a locally hosted media server

* [SkyTube](https://github.com/SkyTubeTeam/SkyTube) ⭐ 2,791 | 🐛 267 | 🌐 Java | 📅 2026-09-18: An open-source YouTube app for Android
...
* [ViewTube](https://github.com/ViewTube/viewtube-vue) ⭐ 1,476 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-24: An alternative front-end for YouTube, written in Vue.js, uses Plyr video player; supports SponsorBlock, multiple Invidious instances support, chapters

* [Youtube-viewer](https://github.com/trizen/youtube-viewer) ⭐ 1,316 | 🐛 47 | 🌐 Perl | 📅 2026-06-15: Lightweight YouTube client for Linux

* [Vividl](https://github.com/Bluegrams/Vividl) ⭐ 1,298 | 🐛 34 | 🌐 C# | 📅 2026-03-10: Modern Windows GUI for youtube-dl
...
* [smtube](https://github.com/smplayer-dev/smtube) ⭐ 54 | 🐛 15 | 🌐 C++ | 📅 2023-05-28: Stand-alone YouTube video player
  * SMPlayer repository: <https://github.com/smplayer-dev/smplayer> ⭐ 1,059 | 🐛 78 | 🌐 C++ | 📅 2026-09-16
...
* [th-ch/youtube-music](https://github.com/th-ch/youtube-music) ⭐ 33,586 | 🐛 691 | 🌐 TypeScript | 📅 2026-09-24: YouTube Music desktop app based on Electron bundled with custom plugins (including built-in ad blocker and downloader)

* [ytmdesktop](https://github.com/ytmdesktop/ytmdesktop) ⭐ 6,541 | 🐛 356 | 🌐 TypeScript | 📅 2026-09-13: Cross-platform (Windows, Mac, and Linux) desktop app for YouTube Music. Has a (proprietary?) remote control app for Android
...
* [Infinity](https://github.com/Docile-Alligator/Infinity-For-Reddit) ⭐ 5,518 | 🐛 162 | 🌐 Java | 📅 2026-09-25: Reddit client for Android
...
* [Top of Reddit](https://github.com/mgerb/top-of-reddit) ⭐ 43 | 🐛 0 | 🌐 Go | 📅 2026-09-25: Top Reddit posts every day
...
* [ProxiTok](https://github.com/pablouser1/ProxiTok) ⭐ 2,144 | 🐛 51 | 🌐 PHP | 📅 2025-05-31: Open source alternative frontend for TikTok made with PHP
  * Official instance: <https://proxitok.pabloferreiro.es/>

### Imgur

* [Omgur](https://github.com/geraldwuhoo/omgur) ⭐ 23 | 🐛 1 | 🌐 Go | 📅 2026-09-25: Omgur is a free and open-source alternative Imgur front-end focused on privacy. Inspired by the Invidious, Nitter, and Teddit projects.
...
* [spotube](https://github.com/KRTirtho/spotube) ⭐ 49,415 | 🐛 865 | 🌐 Dart | 📅 2026-09-25: A lightweight and free Spotify crossplatform-client which handles playback manually, streams music using Youtube & no Spotify premium account is needed

* [SpotX](https://github.com/amd64fox/SpotX) ⭐ 22,472 | 🐛 2 | 🌐 PowerShell | 📅 2026-09-23: Modified Spotify Client for Windows (Windows Only) - Blocking ads and updates for the desktop version of Spotify, disabling podcasts and more

* [spotifyd](https://github.com/Spotifyd/spotifyd) ⭐ 10,782 | 🐛 77 | 🌐 Rust | 📅 2026-05-28: unix daemon, using librespot.

* [psst](https://github.com/jpochyla/psst) ⭐ 9,484 | 🐛 153 | 🌐 Rust | 📅 2026-08-18: Fast and multi-platform Spotify client with native GUI

* [librespot](https://github.com/librespot-org/librespot) ⭐ 7,175 | 🐛 140 | 🌐 Rust | 📅 2026-09-11: Requires Spotify Premium Account - librespot is an open source client library for Spotify. It enables applications to use Spotify's service to control and play music via various backends, and to act as a Spotify Connect receiver. It is an alternative to the official and now deprecated closed-source libspotify. Additionally, it will provide extra features which are not available in the official library
...
* [Xtra](https://github.com/crackededed/Xtra) ⭐ 2,276 | 🐛 188 | 🌐 Kotlin | 📅 2026-09-22: Twitch player and browser for Android
...
* [SearXNG](https://github.com/searxng/searxng) ⭐ 37,638 | 🐛 195 | 🌐 Python | 📅 2026-09-25: SearXNG is a free internet metasearch engine which aggregates results from various search services and databases. Users are neither tracked nor profiled (SearXNG is a fork of searx)
...
* [Lingva Translate](https://github.com/TheDavidDelta/lingva-translate) ⭐ 1,847 | 🐛 47 | 🌐 TypeScript | 📅 2023-08-01: Alternative front-end for Google Translate, serving as a free and open-source translator with over a hundred languages available
...
* [SlimSocial](https://github.com/rignaneseleo/SlimSocial-for-Facebook) ⭐ 542 | 🐛 10 | 🌐 Dart | 📅 2026-09-25: Android, alternative front-end for Facebook, built with Java
...
* [Sengi](https://github.com/NicolasConstant/sengi) ⭐ 572 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-12: cross-platform multi-account Mastodon & Pleroma desktop client
...
* [RPiPlay](https://github.com/FD-/RPiPlay) ⭐ 5,225 | 🐛 105 | 🌐 C++ | 📅 2023-04-14: An open-source AirPlay mirroring server for the Raspberry Pi. Supports iOS 9 and up.
...
* [SongRec](https://github.com/marin-m/SongRec) ⭐ 1,969 | 🐛 71 | 🌐 Rust | 📅 2026-09-05: Open-source Shazam client for Linux, written in Rust
...
* [vaultwarden](https://github.com/dani-garcia/vaultwarden) ⭐ 68,160 | 🐛 87 | 🌐 Rust | 📅 2026-09-25: Password manager. Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden\_rs

* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,158 | 🐛 2,464 | 🌐 Go | 📅 2026-09-25: Lightweight git server. Git with a cup of tea, painless self-hosted git service

* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,611 | 🐛 164 | 🌐 Python | 📅 2026-09-25: Open source self-hosted web archiving. Takes URLs/browser history/bookmarks/Pocket/Pinboard/etc., saves HTML, JS, PDFs, media, and more

* [etherpad-lite](https://github.com/ether/etherpad-lite) ⭐ 18,556 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-25: Collaborative rich text editor. A modern really-real-time collaborative document editor

* [PrivateBin](https://github.com/PrivateBin/PrivateBin) ⭐ 8,616 | 🐛 209 | 🌐 PHP | 📅 2026-09-24: Zero knowledge encrypted paste-bin. A minimalist, open source online pastebin where the server has zero knowledge of pasted data. Data is encrypted/decrypted in the browser using 256 bits AES

* [hedgedoc](https://github.com/hedgedoc/hedgedoc) ⭐ 7,444 | 🐛 302 | 🌐 TypeScript | 📅 2026-09-25: Collaborative markdown editor. A platform to write and share markdown
...
* [libredirect](https://github.com/libredirect/libredirect) ⭐ 4,065 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-25: A web extension that redirects popular sites to alternative privacy-friendly frontends and backends. Actively maintained fork of Privacy Redirect that supports Youtube, Youtube Music, Twitter, TikTok, Imgur, Reddit, Searx, Google Translate, Google Maps, Wikipedia, and Medium
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 68,116 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-25: An efficient blocker for Chromium and Firefox. Fast and lean
...
* [Pluja's Awesome Privacy](https://github.com/pluja/awesome-privacy) ⭐ 19,851 | 🐛 610 | 🌐 Python | 📅 2026-07-15: A curated list of services and alternatives that respect your privacy because privacy matters.
